        ...
        <div class='nav-wrapper blue-grey'>
          <div class='container'>
            ...
            <ul class='right hide-on-med-and-down'>
              ...
              <li>
                <a href='admin/sessions/logout'>Logout<i class='material-icons small right'>lock_open</i></a>
              </li>
              <?php } else { ?>
              <li>
                <a href='admin/login.html'>Login<i class='material-icons small right'>lock</i></a>
              </li><?php } ?>
            </ul>
