   ...
   <body class='grey lighten-5 admin-page'>
     <header>
         ...
         <nav class='blue-grey hide-on-large-only'>
           ...
           <div class='container'>
             <a href='#' class='brand-logo'>Sidebar Editor</a>
           </div>
         </nav>
     </header>
       ...
       <div class='container'>
           <div class='row'>
             ...
             <div class='error-message col s12 m8 green' id='success'>
               <h4>Your sidebar has been updated. Click <a href='../../index' class='black-text'>here</a> to see it</h4>
             </div>
         ...
         <div class='row'>
           <div class='col s12'>
             ...
             while ($content_row = $content_result->fetch_assoc()) {
               $id = $content_row['id'];
               $about = htmlspecialchars_decode($content_row['about'], ENT_QUOTES);
             ?>
             <form action='bin/update-sidebar.php?id=<?php echo $id; ?>' method='post'>
               <div class='input-field'>
                 <textarea name='content' id='content' class='materialize-textarea'><?php echo $about; ?></textarea>
